...
class PhoneAuthBloc extends Bloc<PhoneAuthEvent, PhoneAuthState> {
  ...
  PhoneAuthBloc({required this.phoneAuthRepository}) : super(PhoneAuthInitial()) {
    ...
    on<OnPhoneAuthErrorEvent>((event, emit) => emit(PhoneAuthError(error: event.error)));
  ...
  Future<void> _onSendOtp(SendOtpToPhoneEvent event, Emitter<PhoneAuthState> emit) async {
  ...
  Future<void> _onVerifyOtp(VerifySentOtpEvent event, Emitter<PhoneAuthState> emit) async {
    try {
      emit(PhoneAuthLoading());
  ...
  Future<void> _loginWithCredential(OnPhoneAuthVerificationCompleteEvent event, Emitter<PhoneAuthState> emit) async {
